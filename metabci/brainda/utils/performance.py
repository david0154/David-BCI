...
def _theoretical_itr(y_true: ndarray, y_pred: ndarray, Tw: float) -> float:
    """Theoretical information transfer rate of DBCI
...
def _practical_itr(y_true: ndarray, y_pred: ndarray, Tw: float, Ts: float) -> float:
    """Practical information transfer rate of DBCI
...
class Performance(BaseEstimator, TransformerMixin):
    """Evaluation of DBCI performance.
    ...
    .. code-block:: python
       ...
       :caption: Example
        ...
        1.from davidbci.brainda.utils.performance import Performance.\n
