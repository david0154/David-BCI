...
class BNCI2014001(BaseDataset):
    ...
    Dataset IIa from DBCI Competition 4 [1]_.

    **Dataset Description**

    This data set consists of EEG data from 9 subjects.  The cue-based DBCI
    ...
    .. [1] Tangermann, M., Müller, K.R., Aertsen, A., Birbaumer, N., Braun, C.,
           ...
           and Nolte, G., 2012. Review of the DBCI competition IV.
...
class BNCI2014004(BaseDataset):
    ...
    Dataset B from DBCI Competition 2008.
