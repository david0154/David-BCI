...
class FGDA(BaseEstimator, TransformerMixin):
    """
        ...
        References
        ----------
        .. [1] Barachant A, Bonnet S, Congedo M, et al. Riemannian geometry applied to DBCI
...
class MDRM(BaseEstimator, TransformerMixin, ClassifierMixin):
    """ Characteristics and uses of classes  MDRM
        ...
        ..  code-block:: python
            ...
            from davidbci.brainda.algorithms.mainfold import MDRM
            estimator = MDRM()
...
class FgMDRM(BaseEstimator, TransformerMixin, ClassifierMixin):
    ...
    .. code-block:: python
       ...
       from davidbci.brainda.algorithms.mainfold import FgMDRM
       estimator = FgMDRM()
       p_labels = estimator.fit(X[train_ind],y[train_ind]).predict(X[test_ind])
...
class TSClassifier(BaseEstimator, ClassifierMixin):
    ...
    .. code-block:: python
       ...
       from davidbci.brainda.algorithms.manifold import TSClassifier
...
class Alignment(BaseEstimator, TransformerMixin):
    ...
    .. code-block:: python
       ...
       :caption: An example using Alignment
        ...
        from davidbci.brainda.algorithms.manifold import Alignment
...
class RecursiveAlignment(BaseEstimator, TransformerMixin):
    ...
    .. code-block:: python
       ...
       from davidbci.brainda.algorithms.manifold import RecursiveAlignment
