...
class SCCA(BaseEstimator, TransformerMixin, ClassifierMixin):
    ...
    .. code-block:: python
       :caption: A example using SCCA
        ...
        from davidbci.brainda.algorithms.decomposition.cca import SCCA
        estimator = SCCA()
...
class FBItCCA(FilterBankSSVEP, ClassifierMixin):
    ...
    .. [1] Bolaños M C, Ballestero S B, Puthusserypady S. Filter bank approach for enhancement of supervised Canonical
        Correlation Analysis methods for SSVEP-based DBCI spellers[C]//2021 43rd Annual International Conference of
...
class MsCCA(BaseEstimator, TransformerMixin, ClassifierMixin):
    ...
    References
    ----------
    .. [1] Zhang YU, Zhou G, Jin J, et al. Frequency recognition in SSVEP-based DBCI using multiset canonical correlation
...
class FBMsCCA(FilterBankSSVEP, ClassifierMixin):
    ...
    References
    ----------
    .. [1] Zhang Y U, Zhou G, Jin J, et al. Frequency recognition in SSVEP-based DBCI using multiset canonical correlation
        analysis[J]. International journal of neural systems, 2014, 24(04): 1450013.
     """
    def __init__(
        self,
...
class MsetCCA(BaseEstimator, TransformerMixin, ClassifierMixin):
    ...
    References
    ----------
    .. [1]  Zhang YU, Zhou G, Jin J, et al. Frequency recognition in SSVEP-based DBCI using multiset canonical
...
class FBMsetCCA(FilterBankSSVEP, ClassifierMixin):
    ...
    References
    ----------
    .. [1] Zhang Y U, Zhou G, Jin J, et al. Frequency recognition in SSVEP-based DBCI using multiset canonical
        correlation analysis[J]. International journal of neural systems, 2014, 24(04): 1450013.
