from davidbci.brainflow.amplifiers import LSLInlet, DataInlet, MarkerInlet
...
class LSLapps():
    ...
    DSI and so on. For davidbci, here we just provide a pathway for reading 
    lsl data streams, which means as long as the the LSL providing the app, 
    the davidbci could support its online application. Considering the 
