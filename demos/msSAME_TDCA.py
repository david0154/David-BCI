...
from davidbci.brainda.algorithms.decomposition.base import generate_filterbank, generate_cca_references
from davidbci.brainda.algorithms.transfer_learning import SAME, MSSAME
...
indices = generate_shuffle_indices(david, n_splits=n_splits,train_size=1,validate_size=1,test_size=4)  # Nt = 2
